    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('daily_limit', models.DecimalField(decimal_places=2, default=100.0, max_digits=12)),
                ('weekly_limit', models.DecimalField(decimal_places=2, default=500.0, max_digits=12)),
                ('monthly_limit', models.DecimalField(decimal_places=2, default=2000.0, max_digits=12)),
                ('is_self_excluded', models.BooleanField(default=False)),
                ('self_exclusion_end_date', models.DateField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('document_type', models.CharField(choices=[('id_card', 'ID Card'), ('passport', 'Passport'), ('driving_license', 'Driving License'), ('utility_bill', 'Utility Bill'), ('bank_statement', 'Bank Statement')], max_length=20)),
